{lib, ...}: let
  ...
  homebrew_mirror_env = {
    ...
    # HOMEBREW_BREW_GIT_REMOTE = "https://mirrors.ustc.edu.cn/git/homebrew/brew.git";
    # HOMEBREW_CORE_GIT_REMOTE = "https://mirrors.ustc.edu.cn/git/homebrew/homebrew-core.git";
